...
<body>
  ...
  <div class="p-x-20">
    <div class="max-w-600 m-x-auto mt-30 p-50 bg-white rounded-8 shadow-md">
      ...
      <form id="update-task-form" action="<?php echo Uri::create('tasks/update/' . $task['id']); ?>" method="POST">
        ...
        <div class="mb-25">
          ...
          <textarea name="title" id="title" class="w-100p p-y-10 p-x-20 rounded-6 border border-gray-medium resize-vertical" rows="3" required><?php echo e(Arr::get($inputs, 'title', $task['title'])); ?></textarea>
        </div>
